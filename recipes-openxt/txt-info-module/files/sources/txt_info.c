...
#define TXT_PRIV_CR_BASE    0xfed20000
#define TXT_PRIV_CR_SIZE    0x10000
#define TXT_PUB_CR_BASE	    0xfed30000
#define TXT_PUB_CR_SIZE	    0x10000
static const struct resource txt_resources[] = {
	{
		.start = TXT_PRIV_CR_BASE,
		.end = TXT_PRIV_CR_BASE + TXT_PRIV_CR_SIZE - 1,
...
#define TXT_PRIV_CR_INDEX   0
#define TXT_PUB_CR_INDEX    1
...
/* Registers offset from TXT_{PRIV,PUB}_CR_BASE */
