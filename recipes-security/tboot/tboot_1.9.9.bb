...
SRC_URI = " \
    ...
    file://0006-pcr-calc-refactor-and-read-event-log-from-file.patch \
    file://0007-pcr-calc-Add-0x40f-event-emulation.patch \
    file://0008-acmmatch-Add-utility-to-match-ACM-with-platform.patch \
"
